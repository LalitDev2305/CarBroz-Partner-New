...
/**
 * Apple Keychain-backed [SecureStorage] adapter.
 *
 * Items are device-bound and use `AfterFirstUnlockThisDeviceOnly`, allowing legitimate background
 * work after first unlock while excluding secrets from migration and backup restoration.
 */
