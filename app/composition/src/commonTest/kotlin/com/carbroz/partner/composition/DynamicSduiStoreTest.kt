...
class DynamicSduiStoreTest {
    ...
    @Test
    fun `dynamic store validates destination identity and renders trusted screen`() = runTest {
    ...
    private fun kotlinx.coroutines.test.TestScope.createStore(
        ...
        navigation = NavigationStore(NavigationState(listOf(SplashDestination))),
