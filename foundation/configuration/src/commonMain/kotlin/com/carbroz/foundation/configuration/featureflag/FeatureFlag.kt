...
/**
 * Stable product-neutral feature flag identifier owned by application configuration.
 *
 * Keys remain explicit strings so local or remote providers can map their own
 * storage model without leaking vendor-specific types into foundation code.
 */
data class FeatureFlag(val key: String) {
    ...
    private companion object {
        val KEY_PATTERN = Regex("^[a-z][a-z0-9_.-]{2,63}$")
    }
}
